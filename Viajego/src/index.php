...
<body>
    ...
    <div class="top-bar">
        <div class="container d-flex justify-content-end align-items-center">
            ...
            <a href="#" class="text-decoration-none text-secondary">Contacto</a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light custom-navbar">
        <div class="container">
            <a class="navbar-brand" href="/">
                <img src="/img/logo.png" alt="ViajeGO Logo" height="30" class="d-inline-block align-text-top">
            </a>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    ...
                    <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                        <a href="#paquete-personalizado" class="btn btn-hero-primary btn-lg">Armar Viaje</a>
                        <a href="#catalogo-nacional" class="btn btn-hero-secondary btn-lg">Ver Ofertas</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-5 pt-5" id="catalogo-nacional">
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                ...
                <div class="d-flex justify-content-center search-bar-catalogo">
                    <div class="input-group" style="max-width: 600px;">
                        <input type="text" class="form-control" placeholder="Buscar destino (Ej: Cancún)" aria-label="Buscar destino">
    ...
    <div class="container mt-5 pt-5" id="paquete-personalizado">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h2 class="fw-bold mb-4" style="color: var(--color-texto-oscuro);">Arma tu Paquete Personalizado</h2>
            </div>
            <div class="col-lg-10">
