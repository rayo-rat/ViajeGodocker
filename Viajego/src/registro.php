            ...
            <div class="col-md-6 col-lg-5">
                <div class="card shadow-lg border-0">
                    <div class="card-body p-5">
                        <h2 class="card-title text-center mb-4 fw-bold" style="color: var(--color-turquesa);">Crear Cuenta</h2>
                        ...
                        <form method="POST" action="registro.php">
                            ...
                            <p class="text-center text-secondary">
                                ¿Ya tienes una cuenta? <a href="/login.php" style="color: var(--color-turquesa); text-decoration: none;">Iniciar Sesión</a>
                            </p>
                        </form>
                    </div>
                </div>
